...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    expenses?: boolean | User$expensesArgs
  ...
  export type UserGetPayload<S extends boolean | null | undefined | UserArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        P extends 'expenses' ? Array < ExpenseGetPayload<S['include'][P]>>  :
        P extends '_count' ? UserCountOutputTypeGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (UserArgs | UserFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'expenses' ? Array < ExpenseGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    expenses<T extends User$expensesArgs= {}>(args?: Subset<T, User$expensesArgs>): Prisma.PrismaPromise<Array<ExpenseGetPayload<T>>| Null>;
  ...
  export type ExpenseGetPayload<S extends boolean | null | undefined | ExpenseArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    ...
    : S extends { select: any } & (ExpenseArgs | ExpenseFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof Expense ? Expense[P] : never
  } 
      : Expense
  ...
  export interface ExpenseDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): Prisma.PrismaPromise<Array<ExpenseGetPayload<T>>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__ExpenseClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
  ...
  export type UserWhereInput = {
    ...
    initialBalance?: IntFilter | number
    currentBalance?: IntFilter | number
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    initialBalance?: IntWithAggregatesFilter | number
    currentBalance?: IntWithAggregatesFilter | number
  }
  ...
  export type ExpenseCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<ExpenseCreateWithoutUserInput>, Enumerable<ExpenseUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<ExpenseCreateOrConnectWithoutUserInput>
  ...
  export type ExpenseUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<ExpenseCreateWithoutUserInput>, Enumerable<ExpenseUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<ExpenseCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<ExpenseUpsertWithWhereUniqueWithoutUserInput>
    createMany?: ExpenseCreateManyUserInputEnvelope
    ...
    connect?: Enumerable<ExpenseWhereUniqueInput>
    update?: Enumerable<ExpenseUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<ExpenseUpdateManyWithWhereWithoutUserInput>
  ...
  export type ExpenseCreateManyUserInputEnvelope = {
    data: Enumerable<ExpenseCreateManyUserInput>
    skipDuplicates?: boolean
  }
